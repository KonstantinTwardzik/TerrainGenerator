...
namespace TerrainGenerator.Utilities
{
    public class HydraulicErosion
    {
        ...
        private double inertia = 0.05f; // At zero, water will instantly change direction to flow downhill. At 1, water will never change direction. 
        private double sedimentCapacityFactor = 4; // Multiplier for how much sediment a droplet can carry
        private double minSedimentCapacity = .01f; // Used to prevent carry capacity getting too close to zero on flatter terrain
        private double erodeSpeed = 0.3f;
        ...
        public double[] Erode(double[] map, int mapSize, int numIterations = 1, bool resetSeed = false)
        {
